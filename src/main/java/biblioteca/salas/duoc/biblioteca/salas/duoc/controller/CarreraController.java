...
public class CarreraController {
    ...
    @GetMapping("/{codigo}")
    @Operation(summary = "Obtener una carrera por codigo", description = "Obtiene una carrera por codigo")
    public Carrera getCarreraByCodigo(@PathVariable String codigo) {
        return carreraService.findByCodigo(codigo);
    }

    @Operation(summary = "Crear una nueva carrera", description = "Permite crear una nueva carrera")
    @ApiResponses(value = {
